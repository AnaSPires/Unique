    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: Stack(children: <Widget>[
              ...
              Padding(
                  padding:
                      EdgeInsets.only(top: 460.0, left: 100.0, right: 100.0),
                  child: Column(children: <Widget>[
                    TextFormField(
                      style: TextStyle(
                        fontSize: 20.0,
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: 535.0, left: 118.71, right: 118.71),
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                        begin: Alignment.topRight,
                  ...
                  child: RaisedButton(
                      ...
                      child: Padding(
                        ...
                        child: Text("Bora lá", style: TextStyle(fontSize: 26)),
                      )),
                ),
              ),
              Padding(
                  padding:
                      EdgeInsets.only(top: 600.0, left: 116.21, right: 116.21),
                  child: InkWell(
                    onTap: () {
                      _navigateToCadastro();
                    },
